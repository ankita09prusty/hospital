...
<body>
    ...
    <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:30px; margin-top: 1% !important;">Prime Care
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <h7 class="animated bounceInDown">Welcome to our hospital, where expertise meets compassion. Our team of experienced doctors and staff is dedicated to providing exceptional healthcare services to our patients. With years of training and hands-on experience, our doctors bring a wealth of knowledge and expertise to the table. </h7>
